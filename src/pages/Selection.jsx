...
const Selection = () => {
  ...
  const options = [
    ...
    { icon: BarChart3, title: "View Shop Analysis", subtitle: "Existing User", description: "Track your business performance with detailed analytics.", path: "/expenditure-analytics", color: "text-primary" },
  ];
